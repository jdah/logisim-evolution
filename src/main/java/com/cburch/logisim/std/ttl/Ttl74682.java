...
public class Ttl74682 extends AbstractTtlGate {
  ...
  public static final int PORT_INDEX_nPgrQ = 0;
  ...
  public void ttlpropagate(InstanceState state) {
    Value pEqQ = Value.FALSE, pGrQ = Value.FALSE;
    ...
    if (pEqQ != Value.ERROR && pGrQ != Value.ERROR) {
      pEqQ = p == q ? Value.TRUE : Value.FALSE;
      pGrQ = p > q ? Value.TRUE : Value.FALSE;
    }

    state.setPort(PORT_INDEX_nPeqQ, pEqQ.not(), 1);
    state.setPort(PORT_INDEX_nPgrQ, pGrQ.not(), 1);
  }
